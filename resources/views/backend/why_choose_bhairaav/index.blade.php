        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12 text-right">
                    <div class="dropdown">
                        <a class="btn btn-primary" href="{{ route('why_choose_bhiraavs.create') }}">
                ...
                <table class="table hover multiple-select-row data-table-export1 nowrap p-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="no-export">
                                <a href="{{ route('why_choose_bhiraavs.edit', $value->id) }}">
                            ...
                            <td class="no-export">
                                <form action="{{ route('why_choose_bhiraavs.destroy', $value->id) }}" method="post">
                                    @csrf
                                    @method('DELETE')
    ...
    $('.data-table-export1').DataTable({
        ...
        buttons: [
            ...
            },
            {
               ...
               header: true,
               title: 'All  Why Choose Bhairaav List',
