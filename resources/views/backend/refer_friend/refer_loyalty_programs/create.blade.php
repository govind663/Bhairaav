...
@section('title')
Bhairaav | Add Refer Loyalty Program
@endsection
...
<div class="pd-ltr-20 xs-pd-20-10">
    <div class="min-height-200px">
        <div class="page-header">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="title">
                        <h4>Add Refer Loyalty Program</h4>
                    </div>
        ...
        <form method="POST" action="{{ route('refer_loyalty_programs.store') }}" class="form-horizontal" enctype="multipart/form-data">
            @csrf
