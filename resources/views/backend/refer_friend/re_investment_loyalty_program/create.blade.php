...
@section('title')
Bhairaav | Add Re-Invest Loyalty Program
@endsection
...
<div class="pd-ltr-20 xs-pd-20-10">
    <div class="min-height-200px">
        <div class="page-header">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="title">
                        <h4>Add Re-Invest Loyalty Program</h4>
                    </div>
        ...
        <form method="POST" action="{{ route('re_investment_loyalty_programs.store') }}" class="form-horizontal" enctype="multipart/form-data">
            @csrf
