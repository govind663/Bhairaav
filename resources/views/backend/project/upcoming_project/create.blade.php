...
<div class="pd-ltr-20 xs-pd-20-10">
    <div class="min-height-200px">
        ...
        <form method="POST" action="{{ route('upcoming_projects.store') }}" class="form-horizontal" enctype="multipart/form-data">
            @csrf
