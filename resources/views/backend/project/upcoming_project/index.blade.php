...
@section('title')
Bhairaav | Manaage  Upcoming Projects
@endsection
...
<div class="pd-ltr-20 xs-pd-20-10">
    <div class="min-height-200px">
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12 text-right">
                    <div class="dropdown">
                        <a class="btn btn-primary" href="{{ route('upcoming_projects.create') }}">
                            <i class="fa fa-plus" aria-hidden="true"> </i>  Upcoming Projects
                        </a>
        ...
        <div class="card-box mb-30">
            <div class="pd-20">
                <h4 class="text-blue h4">All  Upcoming Projects List</h4>
            </div>
            <div class="pb-20">
                        ...
                        <tr>
                            ...
                            <td class="text-wrap text-justify">
                                @if(!empty($value->image))
                                    <a href="{{url('/')}}/bhairaav/projects/upcoming_projects/image/{{ $value->image }}" target="_blank" class="btn btn-primary btn-sm">
                            ...
                            @endif
                            <td class="no-export">
                                <a href="{{ route('upcoming_projects.edit', $value->id) }}">
                            ...
                            <td class="no-export">
                                <form action="{{ route('upcoming_projects.destroy', $value->id) }}" method="post">
                                    @csrf
                                    @method('DELETE')
