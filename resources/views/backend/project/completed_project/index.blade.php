        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12 text-right">
                    <div class="dropdown">
                        <a class="btn btn-primary" href="{{ route('completed_projects.create') }}">
                            <i class="fa fa-plus" aria-hidden="true"> </i>  Completed Projects
                        </a>
                ...
                <table class="table hover multiple-select-row data-table-export1 nowrap p-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @endif
                            <td class="no-export">
                                <a href="{{ route('completed_projects.edit', $value->id) }}">
                            ...
                            <td class="no-export">
                                <form action="{{ route('completed_projects.destroy', $value->id) }}" method="post">
                                    @csrf
                                    @method('DELETE')
