        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12 text-right">
                    <div class="dropdown">
                        <a class="btn btn-primary" href="{{ route('ongoing_projects.create') }}">
                            <i class="fa fa-plus" aria-hidden="true"> </i>  Ongoing Project
                        </a>
                        ...
                        <tr>
                            ...
                            <td class="text-wrap text-justify">
                                @if(!empty($value->image))
                                    <a href="{{url('/')}}/bhairaav/projects/ongoing_projects/image/{{ $value->image }}" target="_blank" class="btn btn-primary btn-sm">
                            ...
                            @endif
                            <td class="no-export">
                                <a href="{{ route('ongoing_projects.edit', $value->id) }}">
                            ...
                            <td class="no-export">
                                <form action="{{ route('ongoing_projects.destroy', $value->id) }}" method="post">
                                    @csrf
                                    @method('DELETE')
