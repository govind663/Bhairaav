...
@section('title')
Bhairaav | Edit Contact Information
@endsection
...
<div class="pd-ltr-20 xs-pd-20-10">
    <div class="min-height-200px">
        ...
        <form method="POST" action="{{ route('contact_information.update', $contact_information->id) }}" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            ...
            <div class="pd-20 card-box mb-30">
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-4 col-md-4">
                        <input type="text" name="location_map_link" id="location_map_link" class="form-control @error('location_map_link') is-invalid @enderror" value="{{ $contact_information->location_map_link }}" placeholder="Enter Location Map Link.">
