...
@section('title')
Bhairaav | Manaage Contact Information
@endsection
        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12 text-right">
                    <div class="dropdown">
                        <a class="btn btn-primary" href="{{ route('contact_information.create') }}">
                ...
                <table class="table data-table-export1 nowrap p-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="no-export">
                                <a href="{{ route('contact_information.edit', $value->id) }}">
                            ...
                            <td class="no-export">
                                <form action="{{ route('contact_information.destroy', $value->id) }}" method="post">
                                    @csrf
                                    @method('DELETE')
