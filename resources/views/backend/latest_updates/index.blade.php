...
@section('title')
Bhairaav | Manaage  Latest Updates
@endsection
...
<div class="pd-ltr-20 xs-pd-20-10">
    <div class="min-height-200px">
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12 text-right">
                    <div class="dropdown">
                        <a class="btn btn-primary" href="{{ route('latest_update.create') }}">
                            <i class="fa fa-plus" aria-hidden="true"> </i>  Latest Updates
                        </a>
        ...
        <div class="card-box mb-30">
            <div class="pd-20">
                <h4 class="text-blue h4">All  Latest Updates List</h4>
            </div>
            <div class="pb-20">
                <table class="table hover multiple-select-row data-table-export1 nowrap p-3">`
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="no-export">
                                <a href="{{ route('latest_update.edit', $value->id) }}">
                            ...
                            <td class="no-export">
                                <form action="{{ route('latest_update.destroy', $value->id) }}" method="post">
                                    @csrf
                                    @method('DELETE')
