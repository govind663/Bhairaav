...
<div class="pd-ltr-20 xs-pd-20-10">
    <div class="min-height-200px">
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <nav aria-label="breadcrumb" role="navigation">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('gallery.index') }}">Manage Career</a>
                            </li>
        ...
        <form method="POST" action="{{ route('careers.update', $career->id) }}" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            @method('PATCH')

            <input type="text" id="id" name="id" hidden  value="{{ $career->id }}">

            <div class="pd-20 card-box mb-30">
                <div class="form-group row mt-3">
                    <label class="col-sm-2"><b>Career Title : <span class="text-danger">*</span></b></label>
                    <div class="col-sm-4 col-md-4">
                        <input type="text" name="career_title" id="career_title" class="form-control @error('career_title') is-invalid @enderror" value="{{ $career->career_title }}" placeholder="Enter Career Title.">
                        @error('career_title')
                    ...
                    <div class="col-sm-4 col-md-4">
                        <input type="file" onchange="careerPreviewFile()" accept=".png, .jpg, .jpeg" name="career_image" id="career_image" class="form-control @error('career_image') is-invalid @enderror" value="{{ $career->career_image }}">
                        <small class="text-secondary"><b>Note : The file size  should be less than 2MB .</b></small>
                        <br>
                        <small class="text-secondary"><b>Note : Only files in .jpg, .jpeg, .png format can be uploaded .</b></small>
                        <br>
                        @if(!empty($career->career_image))
                        <img src="{{ asset('/bhairaav/Career/career_image/'.$career->career_image) }}" alt="{{ $career->career_image }}" >
                        @endif
                        <br>
                        @error('career_image')
                            <span class="invalid-feedback" role="alert">
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-12 col-md-12">
                        <textarea id="career_description" name="career_description" class="textarea_editor form-control border-radius-0 @error('career_description') is-invalid @enderror" placeholder="Enter Career Description ..." value="{{ $career->career_description }}">{{ $career->career_description }}</textarea>
                        ...
                        <tbody>
                            @foreach($jobTitles as $index => $jobTitle)
                                <tr>
                                    <td>
                                        <div class="col-sm-12 col-md-12">
                                            <input type="text" name="job_title[]" class="form-control @error('job_title.*') is-invalid @enderror" value="{{ old('job_title.' . $index, $jobTitle) }}" placeholder="Enter Job Position">
                                            @error('job_title.*')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <button type="button" class="btn btn-danger removeJobPositionRow">Remove</button>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
                ...
                <div class="col-12">
                    ...
                    <table class="table table-bordered p-3" id="dynamicJobDescriptionTable">
                        <tbody>
                            @foreach($jobDescriptions as $index => $jobDescription)
                                <tr>
                                    <td>
                                        <div class="col-sm-12 col-md-12">
                                            <input type="text" name="job_description[]" class="form-control @error('job_description.*') is-invalid @enderror" value="{{ old('job_description.' . $index, $jobDescription) }}" placeholder="Enter Job Description">
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <button type="button" class="btn btn-danger removeJobDescriptionRow">Remove</button>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
