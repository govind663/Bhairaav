            ...
            <div class="pd-20 card-box mb-30">
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-4 col-md-4">
                        <input type="file" onchange="agentPreviewFile()" accept=".png, .jpg, .jpeg" name="logo_image" id="logo_image" class="form-control @error('logo_image') is-invalid @enderror" value="{{ $ourLogo->logo_image }}">
                        ...
                        @enderror
                        <br>
                        @if(!empty($ourLogo->logo_image))
                            <img src="{{url('/')}}/bhairaav/our_logo/logo_image/{{ $ourLogo->logo_image }}" width="150" height="100" alt="{{ $ourLogo->bank_logo }}">
                        @endif
                        <br>
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-12 col-md-12">
                        <textarea type="text" name="description" id="description" class="textarea_editor form-control @error('description') is-invalid @enderror" value="{!! $ourLogo->description !!}" placeholder="Enter Description.">{!! $ourLogo->description !!}</textarea>
                        @error('description')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
