...
<div class="pd-ltr-20 xs-pd-20-10">
    <div class="min-height-200px">
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12 text-right">
                    <div class="dropdown">
                        <a class="btn btn-primary" href="{{ route('our_logos.create') }}">
                            <i class="fa fa-plus" aria-hidden="true"> </i>  Our Logo
                        </a>
        ...
        <div class="card-box mb-30">
            <div class="pd-20">
                <h4 class="text-blue h4">All  Our Logo List</h4>
            </div>
            <div class="pb-20">
