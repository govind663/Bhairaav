...
<div class="pd-ltr-20 xs-pd-20-10">
    <div class="min-height-200px">
        ...
        <form method="POST" action="{{ route('the_legacy.store') }}" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-4 col-md-4">
                        <input type="file" onchange="agentPreviewFile()" accept=".png, .jpg, .jpeg, .pdf" name="legacies_image" id="legacies_image" class="form-control @error('legacies_image') is-invalid @enderror" value="{{old('legacies_image')}}">
...
<script>
    function agentPreviewFile() {
        const fileInput = document.getElementById('legacies_image');
