...
<div class="pd-ltr-20 xs-pd-20-10">
    <div class="min-height-200px">
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12 text-right">
                    <div class="dropdown">
                        <a class="btn btn-primary" href="{{ route('our_teams.create') }}">
        ...
        <div class="card-box mb-30">
            <div class="pd-20">
                <h4 class="text-blue h4">All  Leader List</h4>
            </div>
            <div class="pb-20">
                <table class="table hover multiple-select-row data-table-export1 nowrap p-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-wrap text-justify">
                                ...
                                <div class="name-avatar d-flex align-items-center">
                                    <div class="avatar mr-2 flex-shrink-0">
                                        <img src="{{url('/')}}/bhairaav/team_leader/profile_image/{{ $value->profile_image }}" class="border-radius-100 shadow" width="40" height="40" alt="{{ $value->profile_image }}" />
                                    </div>
                                    <div class="txt">
                            ...
                            <td class="no-export">
                                <a href="{{ route('our_teams.edit', $value->id) }}">
                            ...
                            <td class="no-export">
                                <form action="{{ route('our_teams.destroy', $value->id) }}" method="post">
                                    @csrf
                                    @method('DELETE')
