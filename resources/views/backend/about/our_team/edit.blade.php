        ...
        <form method="POST" action="{{ route('our_teams.update', $team->id) }}" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-4 col-md-4">
                        <input type="file" onchange="agentPreviewFile()" accept=".png, .jpg, .jpeg" name="profile_image" id="profile_image" class="form-control @error('profile_image') is-invalid @enderror" value="{{ $team->profile_image }}">
                        ...
                        <img src="{{url('/')}}/bhairaav/leader/profile_image/{{ $team->profile_image }}" alt="{{ $team->profile_image }}">
                        @endif
                        <br>
