        ...
        <form method="POST" action="{{ route('our-leader.update', $leader->id) }}" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-4 col-md-4">
                        <textarea type="text" name="description" id="description" class="form-control @error('description') is-invalid @enderror" value="{{ $leader->description }}" placeholder="Enter Description.">{{ $leader->description }}</textarea>
                        @error('description')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
