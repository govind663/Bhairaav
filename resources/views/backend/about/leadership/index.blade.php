        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12 text-right">
                    <div class="dropdown">
                        <a class="btn btn-primary" href="{{ route('our-leader.create') }}">
                            <i class="fa fa-plus" aria-hidden="true"> </i>  Leader
                        </a>
                ...
                <table class="table hover multiple-select-row data-table-export1 nowrap p-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="no-export">
                                <form action="{{ route('our-leader.destroy', $value->id) }}" method="post">
                                    @csrf
                                    @method('DELETE')
