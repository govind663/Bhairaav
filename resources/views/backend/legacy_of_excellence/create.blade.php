...
@section('title')
Bhairaav | Add Legacy of Excellence
@endsection
...
<div class="pd-ltr-20 xs-pd-20-10">
    <div class="min-height-200px">
        <div class="page-header">
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <div class="title">
                        <h4>Add Legacy of Excellence</h4>
                    </div>
        ...
        <form method="POST" action="{{ route('legacy_of_excellence.store') }}" class="form-horizontal" enctype="multipart/form-data">
            @csrf
