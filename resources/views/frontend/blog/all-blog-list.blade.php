...
@section('content')
    ...
    <section class="cs_page_heading cs_breadcumbs cs_primary_bg cs_bg_filed cs_center" data-src="{{ asset('frontend/assets/img/bg/3051.jpg') }}">
        <div class="container">
        ...
        <div class="container">
          <div class="row cs_row_gap_60 cs_gap_y_80">
            ...
            <div class="col-lg-4 col-md-6">
              <div class="cs_post cs_style_1 cs_size_1">
                <a class='cs_post_thumb cs_radius_5 overflow-hidden d-block cs_mb_29 cs_mb_lg_20 position-relative' href='blog-details.html'>
                  <img src="{{ asset('frontend/assets/img/blog/Bhairaav-Signature-Beckons-You-to-Savour-an-Exciting-New-Lifestyle-thumbnail.jpg') }}" alt="Feature">
                  <span class="cs_hover_icon cs_center position-absolute cs_white_color cs_zindex_2 cs_radius_5">
                    <i class="fa-solid fa-arrow-up-right-from-square"></i>
                  </span>
                </a>
                <div class="cs_post_info">
                  ...
                  <h2 class="cs_post_title cs_fs_21 cs_bold">
                    <a href='blog-details.html'>Bhairaav Signature Beckons You to Savour an Exciting New Lifestyle
                    </a>
                  </h2>
                  <a class='cs_btn cs_style_2 cs_medium cs_radius_5 cs_fs_15' href='blog-details.html'>
                    Learn More
            ...
            <div class="col-lg-4 col-md-6">
              <div class="cs_post cs_style_1 cs_size_1">
                ...
                <div class="cs_post_info">
                  ...
                  <h2 class="cs_post_title cs_fs_21 cs_bold">
                    <a href='blog-details.html'>What You Should Be Looking For In An Office Space
                    </a>
                  </h2>
                  <a class='cs_btn cs_style_2 cs_medium cs_radius_5 cs_fs_15' href='blog-details.html'>
                    Learn More
            ...
            <div class="col-lg-4 col-md-6">
              <div class="cs_post cs_style_1 cs_size_1">
                <a class='cs_post_thumb cs_radius_5 overflow-hidden d-block cs_mb_29 cs_mb_lg_20 position-relative' href='blog-details.html'>
                  <img src="{{ asset('frontend/assets/img/blog/Thumb_UnderstandingThe-New-age-way-of-life.jpg') }}" alt="Feature">
                  <span class="cs_hover_icon cs_center position-absolute cs_white_color cs_zindex_2 cs_radius_5">
                    <i class="fa-solid fa-arrow-up-right-from-square"></i>
                  </span>
                </a>
