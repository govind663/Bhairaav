            ...
            <div class="row align-items-center cs_gap_y_45">
                <div class="col-lg-6">
                    <div class="cs_pr_110 wow fadeIn" data-wow-duration="0.8s" data-wow-delay="0.2s">
                        <img src="{{ asset('frontend/assets/img/about/ak_648_455877381-1600672668_700x700.jpeg') }}"
                            alt="Service" class="cs_radius_5">
                    </div>
                </div>
                <div class="col-lg-6">
                    ...
                    <p class="text-justify">
                        Mr. Shri. Madan Jain through his dynamism as an entrepreneur established Bhairaav Group in the year
                        1972.
                        In his initial years as a businessman, he had a largely successful stint in the garment industry.
                        Later
                        on, 21st century saw the group diversifying into real estate, foraying into building a robust
                        portfolio
                        of world-class residential and commercial realty
            ...
            <div class="overflow-hidden">
                <ul class="cs_about_feature_list_1 cs_mp_0">
                    <li class="text-center">
                        ...
                        <h3 class="cs_fs_21 mb-0">Decades of experience
                        </h3>
                    </li>
                    <li class="text-center">
                        <h3 class="cs_fs_38 cs_bold main-counter cs_mb_9">1.5 Million sq.ft.
                        </h3>
                        <h3 class="cs_fs_21 mb-0">Established Creations
                        </h3>
                    </li>
                    <li class="text-center">
                        <h3 class="cs_fs_38 cs_bold main-counter cs_mb_9">5 Million + sq.ft.
                        </h3>
                        <h3 class="cs_fs_21 mb-0">Ongoing & Upcoming Projects
                        </h3>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="cs_pl_110">
                        <div class="cs_section_heading cs_style_1">
                            ...
                            <p class="mb-0 cs_white_color text-justify">
                                Since inception the company has grown multi-fold and
                                flourished over the years through sheer hard work, dedication and commitment to quality. By
                                clinching
                                numerous strategic land deals and delivering several multi-storied apartments comprising
                                contemporary
                                world-class amenities, Bhairaav Group crafts lifestyles and life-spaces that suit
                                contemporary times.
                                Bhairaav Housing Corporation Limited , the Realty Division of the Bhairaav Group is
                                acknowledged for
                                high quality construction and transparency in dealings, the group is steadily forging ahead
                                to create
                                its own niche in the Real Estate Industry.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row align-items-center cs_mobile_reverse cs_gap_y_40">
                <div class="col-lg-6">
                    <div class="cs_pr_110">
                        <div class="cs_section_heading cs_style_1">
                            ...
                            <p class="mb-0 cs_white_color text-justify">Bhairaav Group will be celebrating its 49th year of
                                existence
                                in the year 2020. The group ventured into real estate in the year 1997 under the able
                                guidance of
                                Chairman Shri Madan Jain. Since then dedication, reliability, commitment and quality have
                                been the four
                                core values of the group. The group has constructed several multi-storied contemporary
                                structures with
                                high-class amenities to suit modern needs of life in sync with its signature line - better
                                lifestyle,
                                better life.
                ...
                <div class="col-lg-6">
                    <div class="cs_image_layer cs_style_2 position-relative cs_bg_filed cs_width_right_50_vw"
                        data-src="assets/img/about/2150456255.jpg"></div>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="cs_slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0"
                        ...
                        <div class="cs_slider_wrapper">
                                    ...
                                    <div class="cs_iconbox_subtitle mb-0 more text-justify">
                                        <ul class="cs_list cs_style_1 cs_mp_0">
                                            <li>
                                                ...
                                                Design living spaces in tune with lifestyle of customers
                                            </li>
                                            <li>
                                                <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <g clip-path="url(.clip0_95_13)">
                                            ...
                                            <li>
                                                ...
                                                Constantly innovate and expand creative repertoire through meticulous planning and move
                                            ...
                                            <li>
                                                ...
                                                Involve and evolve our core asset and partners in progress - employees
                                            </li>
                                            <li>
                                                <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <g clip-path="url(.clip0_95_13)">
                                                ...
                                                Constantly elevate standards and create benchmark in real estate field
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="cs_slide">
                                <div class="cs_iconbox cs_style_3 cs_radius_5 cs_white_bg">
                                    <div class="cs_iconbox_icon cs_mb_29 cs_center cs_radius_5 cs_white_bg">
                                        <img src="{{ asset('frontend/assets/img/about/icon/value.png') }}" alt="Icon"></div>
                                    ...
                                    <div class="cs_iconbox_subtitle mb-0 more text-justify">
                                        <ul class="cs_list cs_style_1 cs_mp_0">
                                            <li>
                                                ...
                                                processes, and procedures so as to deliver improved product with timely
                                                possession.
                                            </li>
                                        </ul>
                                    </div>
            ...
            <div class="row align-items-center cs_gap_y_40">
                <div class="col-lg-6 text-justify">
                    ...
                    <p class="text-justify">
                        ...
                        company, poised to soar to greater heights, stirred with a new vision and mighty wave of hope, faith
                        and delight.
                    </p>
                    <p class="text-justify">
                        The tall red blocks suggest the Realty aspect of the company. Vermillion (red) is a sacred colour and
                        symbolizing strength. It also stands for a brick, which is moulded from mother earth - the true
                        foundation for mankind's existence.
                    </p>
                    <p class="text-justify">
                        ...
                        philosophy of the company – <b>in it's pursuit to emerge as a premium brand to reckon with and be
                        the better choice for it's clientele.</b>
                    </p>
                </div>
                <div class="col-lg-6">
