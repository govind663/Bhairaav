            ...
            <div class="row cs_gap_y_45">
                <div class="col-lg-4">
                    <div class="cs_section_heading cs_style_1">
                        <h2 class="cs_fs_38 cs_bold mb-10 ">Architects</h2>
                    </div>
                    <ul class="cs_list cs_style_1 cs_mp_0">
                        ...
                        <li>
                            ...
                            M/s. Soyuz Talib Architects Pvt. Ltd.
                ...
                <div class="col-lg-4">
                    <div class="cs_section_heading cs_style_1">
                        <h2 class="cs_fs_38 cs_bold mb-10 ">Structural Engineers</h2>
                    </div>
                    <ul class="cs_list cs_style_1 cs_mp_0">
                        <li>
                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                            ...
                            Shantilal H. Jain of M/s Structural Bombay Consultant
                        ...
                        <li>
                            ...
                            Virendra Kumar Jain of M/s Vinit Consultants
                        ...
                        <li>
                            ...
                            Rajesh Ladhad of M/s Structural Concept
                ...
                <div class="col-lg-4">
                    <div class="cs_section_heading cs_style_1">
                        <h2 class="cs_fs_38 cs_bold mb-10 ">Landscape Architects
                        </h2>
                    </div>
                    <ul class="cs_list cs_style_1 cs_mp_0">
                        <li>
            ...
            <div class="container">
                <div class="cs_slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0"
                    ...
                    <div class="cs_slider_wrapper">
                        <div class="cs_slide">
                            <img src="{{ asset('frontend/assets/img/partner/axis-bank-logo.png') }}" />
                        </div>
                        <div class="cs_slide">
                            <img src="{{ asset('frontend/assets/img/partner/hdfc-hl.png') }}" />
                        </div>
                        <div class="cs_slide">
                            <img src="{{ asset('frontend/assets/img/partner/icici.jpg') }}" />
                        </div>
                        <div class="cs_slide">
                            <img src="{{ asset('frontend/assets/img/partner/IIFL.png') }}" />
                        </div>
                        <div class="cs_slide">
                            <img src="{{ asset('frontend/assets/img/partner/kotak.png') }}" />
                        </div>
                        <div class="cs_slide">
                            <img src="{{ asset('frontend/assets/img/partner/lic.png') }}" />
                        </div>
                        <div class="cs_slide">
                            <img src="{{ asset('frontend/assets/img/partner/PNB.png') }}" />
                        </div>
                        <div class="cs_slide">
                            <img src="{{ asset('frontend/assets/img/partner/sbi.png') }}" />
                        </div>
                    </div>
                </div>
